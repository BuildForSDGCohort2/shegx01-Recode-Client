    ...
    <>
      ...
      <div className='flex mt-8'>
        ...
        <div className='flex flex-col ml-8'>
          ...
          <input
            className='mt-1 p-1 capitalize bg-grey text-grey placeholder-grey2
              focus:shadow-outline border border-grey3 focus:outline-none focus:text-fg1 focus:bg-fg' type='text' placeholder='link video with previous channel' value={videoName} onChange={handleVideoNameChange}
          />
        </div>
      </div>
    </>
